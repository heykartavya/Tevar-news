...
export const ArticleCard: React.FC<ArticleCardProps> = ({ article, featured = false, compact = false }) => {
  ...
  if (featured) {
    return (
      <article className="group cursor-pointer flex flex-col mb-8 border-b border-gray-200 pb-8 last:border-0 last:pb-0">
        ...
        <div>
          <div className="flex items-center space-x-2 mb-3">
            <span className="font-sans font-bold text-xs uppercase tracking-widest text-red-700">{article.category}</span>
  ...
  if (compact) {
    return (
      <article className="group cursor-pointer flex gap-4 mb-6 border-b border-gray-100 pb-6 last:border-0 last:pb-0">
        <div className="flex-1">
          <span className="block font-sans font-bold text-[10px] uppercase tracking-widest text-red-700 mb-1">{article.category}</span>
  ...
  return (
    <article className="group cursor-pointer flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col">
        <span className="block font-sans font-bold text-xs uppercase tracking-widest text-red-700 mb-2">{article.category}</span>
